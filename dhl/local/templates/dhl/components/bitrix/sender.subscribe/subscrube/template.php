...
?>
    ...
    <form  id="bx_subscribe_subform_<?=$buttonId?>" role="form" method="post" action="<?=$arResult["FORM_ACTION"]?>" class="site-footer_subscription_form">
        <?=bitrix_sessid_post()?>
        <input type="hidden" name="sender_subscription" value="add">

        <input type="email" name="SENDER_SUBSCRIBE_EMAIL" value="<?=$arResult["EMAIL"]?>" title="<?=GetMessage("subscr_form_email_title")?>" placeholder="<?=htmlspecialcharsbx(GetMessage('subscr_form_email_title'))?>" required>
        <input id="bx_subscribe_btn_<?=$buttonId?>" class="site-footer_subscription_form_btn site-btn site-form_submit site-btn_base site-btn_red " href="#" value="<?=GetMessage("subscr_form_button")?>" type="submit">
    </form>
